...
func _ready():
	...
	master_slider.connect("value_changed", Callable(self, "on_master_slider_change"))
	music_slider.connect("value_changed", Callable(self, "on_music_slider_change"))
	sfx_slider.connect("value_changed", Callable(self, "on_sfx_slider_change"))
